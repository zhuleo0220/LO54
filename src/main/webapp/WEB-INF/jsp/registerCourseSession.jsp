            ...
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="/Client/add" method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name">
                    ...
                    <p class="mbr-text mbr-fonts-style align-center mb-4 display-7">
                        Entrer les informations ci-dessous pour vous inscrire au cours</p>
                    <div class="row">
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="lastname">
                            <input type="text" name="lastname" placeholder="Nom" data-form-field="lastname" class="form-control" value=${lastName} id="lastname-form7-l" pattern="[a-zA-Z]+" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="firstname">
                            <input type="text" name="firstname" placeholder="Prénom" data-form-field="firstname" class="form-control" value=${firstName} id="firstname-form7-l" pattern="[a-zA-Z]+" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="address">
                            <input type="text" name="address" placeholder="Adresse" data-form-field="address" class="form-control" value=${address} id="address-form7-l" required>
                        </div>
                        <div data-for="phone" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <input type="tel" name="phone" placeholder="Téléphone" data-form-field="phone" class="form-control" value=${phone} id="phone-form7-l" required>
                        </div>
                        <div data-for="email" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <input type="email" name="email" placeholder="Email" data-form-field="email" class="form-control" value=${emailUser} id="email-form7-l" required>
                        </div>
